    ...
    Submits a task to generate certificates for given students enrolled in the course.
     ...
     Arguments:
        ...
        student_set : Semantic for student collection for certificate generation.
                      Options are:
                      'all_allowlisted': All students on the certificate allow list.
                      'allowlisted_not_generated': Students on certificate allow list who do not have certificates yet.
